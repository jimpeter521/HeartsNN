...
class CppShapeInferenceResult_HandleShapeAndType : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.CppShapeInferenceResult.HandleShapeAndType) */ {
 public:
  ...
  inline CppShapeInferenceResult_HandleShapeAndType* New() const PROTOBUF_FINAL { return New(NULL); }

  CppShapeInferenceResult_HandleShapeAndType* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class CppShapeInferenceResult_HandleData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.CppShapeInferenceResult.HandleData) */ {
 public:
  ...
  inline CppShapeInferenceResult_HandleData* New() const PROTOBUF_FINAL { return New(NULL); }

  CppShapeInferenceResult_HandleData* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
