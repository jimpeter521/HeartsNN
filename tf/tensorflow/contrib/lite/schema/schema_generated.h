...
struct PadOptionsBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_before_padding(flatbuffers::Offset<flatbuffers::Vector<int32_t>> before_padding) {
    fbb_.AddOffset(PadOptions::VT_BEFORE_PADDING, before_padding);
  }
  void add_after_padding(flatbuffers::Offset<flatbuffers::Vector<int32_t>> after_padding) {
...
inline flatbuffers::Offset<PadOptions> CreatePadOptionsDirect(
  ...
  return tflite::CreatePadOptions(
      _fbb,
      before_padding ? _fbb.CreateVector<int32_t>(*before_padding) : 0,
...
inline void PadOptions::UnPackTo(PadOptionsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = before_padding(); if (_e) { _o->before_padding.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->before_padding[_i] = _e->Get(_i); } } };
  { auto _e = after_padding(); if (_e) { _o->after_padding.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->after_padding[_i] = _e->Get(_i); } } };
}
...
inline flatbuffers::Offset<PadOptions> CreatePadOptions(flatbuffers::FlatBufferBuilder &_fbb, const PadOptionsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _before_padding = _o->before_padding.size() ? _fbb.CreateVector(_o->before_padding) : 0;
  auto _after_padding = _o->after_padding.size() ? _fbb.CreateVector(_o->after_padding) : 0;
  return tflite::CreatePadOptions(
      _fbb,
      _before_padding,
      _after_padding);
